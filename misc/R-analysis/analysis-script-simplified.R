...
setwd("~/symulator/simphony_model_1423444732564/")

library(dplyr)
library(sqldf)

# wczytywanie stanow agentow z pojedynczych instancji
instance_1 <- read.csv2('instance_1/agents_nonaggr_state.2015.lut.09.02_19_17.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_2 <- read.csv2('instance_2/agents_nonaggr_state.2015.lut.09.02_19_15.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_3 <- read.csv2('instance_3/agents_nonaggr_state.2015.lut.09.02_19_17.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_4 <- read.csv2('instance_4/agents_nonaggr_state.2015.lut.09.02_19_16.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_5 <- read.csv2('instance_5/agents_nonaggr_state.2015.lut.09.02_19_16.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_6 <- read.csv2('instance_6/agents_nonaggr_state.2015.lut.09.02_19_17.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_7 <- read.csv2('instance_7/agents_nonaggr_state.2015.lut.09.02_19_15.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_8 <- read.csv2('instance_8/agents_nonaggr_state.2015.lut.09.02_19_17.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_9 <- read.csv2('instance_9/agents_nonaggr_state.2015.lut.09.02_19_15.csv', sep=";", quote="\"", header = TRUE, dec=",")
instance_10 <- read.csv2('instance_10/agents_nonaggr_state.2015.lut.09.02_19_17.csv', sep=";", quote="\"", header = TRUE, dec=",")
...
merged <- sqldf("select * from data_1 union select * from data_2 union select * from data_3 union select * from data_4  
                ...
                dbname = tempfile(tmpdir = c("~/symulator/simphony_model_1423444732564/")))
