@ECHO OFF
TITLE emergent-task-allocation
...
CD emergent-task-allocation

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./emergent-task-allocation.rs
